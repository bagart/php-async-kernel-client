...
use BAGArt\ASKClient\Client\AmpHttpClient;
...
final class AmpHttpTransport implements HttpTransportContract, ASKTickableContract
{
    ...
    public function __construct(
        private readonly AmpHttpClient $client = new AmpHttpClient(),
    ) {
    }
